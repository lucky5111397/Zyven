      ...
      >
        ...
        <div className="w-full max-w-md mx-auto text-left space-y-4 mb-8">
          ...
          <div>
            ...
            <CodeBlock
              code="npm install Zyven-ui-library"
              lang="bash"
            />
          </div>
          ...
          <div>
            ...
            <CodeBlock
              code={`import { ComponentName } from "Zyven-ui-library"`}
              lang="jsx"
            />
          </div>
          ...
          <div>
            ...
            <CodeBlock
              code={`import { UserAvatar, PricingCard } from "zyven-ui-library";
...
function DetailPanel({ component, onBack }) {
  ...
  const importCode = `import { ${component.name} } from "zyven-ui-library";`;

  const usageCode = `import { ${component.name} } from "zyven-ui-library";
  ...
  return (
    ...
    >
      <nav className="sticky top-0 z-40 flex items-center justify-between px-4 sm:px-8 py-3.5 sm:py-4 border-b border-white/[0.05] bg-[#030b0d]/90 backdrop-blur-md shrink-0">
        ...
        >
          <div
            className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-gradient-to-br from-[#3be8ff] to-[#0ab5d4] flex items-center justify-center shadow-[0_0_14px_rgba(59,232,255,0.35)]"
          >
            <img src="/img.png" alt="Zyven" className="w-4 h-4 object-contain drop-shadow-md" />
          </div>
